...
if __name__ == '__main__':
    path = Path(r"D:\TC Data\_data\prod_Feb24\matrectrans.xlsx")
    path_dir_out = Path(r"D:\TC Data\SPP API JSONs\SPP\material_receipt_trans")
    ...
    for sheet in ['Export Worksheet']:  # 'Sheet1'
        ...
        out = df.rename(columns=columns_map) \
            .drop(['invuselineid_1', 'spvb_sapremark_1'], axis=1) \
            .replace({np.nan: None}) \
