...
(
    ...
    [DATE_WSCH_BFR] [DATETIMEOFFSET] NULL,
    [DATE_PLANNING_BFR] [DATETIMEOFFSET] NULL,
    [DATE_APPROVED_BFR] [DATETIMEOFFSET] NULL,
    [DATE_FINISHED_BFR] [DATETIMEOFFSET] NULL,
    [DATE_ACCEPTED_BFR] [DATETIMEOFFSET] NULL,
    [DATE_COMPLETED_BFR] [DATETIMEOFFSET] NULL,

    [DATE_WSCH_AFT] [DATETIMEOFFSET] NULL,
    [DATE_PLANNING_AFT] [DATETIMEOFFSET] NULL,
    [DATE_APPROVED_AFT] [DATETIMEOFFSET] NULL,
    [DATE_FINISHED_AFT] [DATETIMEOFFSET] NULL,
    [DATE_ACCEPTED_AFT] [DATETIMEOFFSET] NULL,
    [DATE_COMPLETED_AFT] [DATETIMEOFFSET] NULL,
