...
GO
CREATE TABLE FROM [dbo].[W_CMMS_DOWNTIME_F]
(
    ...
    [MACHINE_ASSET_UID] [nvarchar](30) NULL,
    ...
    [DOWNTIME_ORIGINAL] DECIMAL(38,20) NULL,
    [DOWNTIME_DATETIME] DATETIME2 NULL,
    [DOWNTIME_DATETIME_ORIGINAL] DATETIME2 NULL,
