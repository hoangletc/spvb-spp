...
BEGIN
    ...
    BEGIN TRY
		...
		SELECT
			...
			, CONVERT(nvarchar(100), WERKS) AS PLANT_CODE
			...
			, CONVERT(nvarchar(100), REPLACE(LTRIM(REPLACE(F.MATNR, '0', ' ')), ' ', '0')) AS MATERIAL_NUMBER
			, CONVERT(nvarchar(100), LGORT) AS STORAGE_LOCATION
			...
			, CONVERT(nvarchar(100), VPRSV) AS PRICE_INDICATOR
			...
			, CONVERT(nvarchar(100), BWART) AS MOVEMENT_TYPE
