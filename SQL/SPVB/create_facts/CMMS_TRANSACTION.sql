...
-- SELECT TOP 10 * FROM [FND].[W_CMMS_WO_STATUS_D]
-- SELECT TOP 10 * FROM [FND].[W_CMMS_WO_F]
-- SELECT TOP 10 * FROM [STG].[W_CMMS_MATU_FS]
-- SELECT TOP 10 * FROM [dbo].[W_CMMS_LOC_D]
-- SELECT TOP 10 * FROM [FND].[W_CMMS_ITEM_D]
